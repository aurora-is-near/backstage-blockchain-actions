...
const backstageExport = ({ backstage_url, template_path, output_path, testing, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (testing) {
        core_default().info(`Testing mode: ${changedFiles.length} changed files, exiting`);
        return true;
    }
    if (changedFiles.length === 0) {
        core_default().info("No changed files, nothing to commit");
        return false;
    }
...
function reexportTemplate(inputs) {
    ...
    if (compiledContent !== existingContent) {
        core_default().info(`Writing ${outputPath}: changed content`);
...
function commitAndPushChanges(path) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield git.push();
        core_default().info("Updated and pushed the changes");
        return true;
    });
}
...
function fetchBackstageEntitiesFromURL(backstageUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        _actions_core__WEBPACK_IMPORTED_MODULE_0___default().info("Connecting to Backstage to fetch available entities");
        const discoveryApi = {
            getBaseUrl() {
                return __awaiter(this, void 0, void 0, function* () {
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_0___default().info(`Total backstage entities: ${entities.items.length}`);
...
function fetchBackstageEntitiesFromRepo(backstageEntitiesRepo) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_0___default().info(`Cloning ${repoUrl}`);
