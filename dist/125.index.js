...
function backstageMetrics({ backstage_url, testing, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            _actions_core__WEBPACK_IMPORTED_MODULE_0___default().info(`API called successfully. Returned data: ${JSON.stringify(data)}`);
            return data;
        }
        catch (error) {
...
function submitMetrics(series) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_0___default().info(`Data to upload: ${JSON.stringify(params)}`);
