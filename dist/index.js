...
var core = __nccwpck_require__(68434);
var core_default = /*#__PURE__*/__nccwpck_require__.n(core);
// EXTERNAL MODULE: ./node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/lodash.js
var lodash = __nccwpck_require__(8749);
...
const getInputsFromFile = (yamlContents) => Object.keys(js_yaml.load(yamlContents).inputs);
...
function getActionInputs(requiredInputs = []) {
    ...
    const inputsFromFile = getInputsFromFile(yamlContents).reduce((acc, current) => (Object.assign(Object.assign({}, acc), { [current]: (0,core.getInput)(current, {
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const helper = core_default().getInput("helper", { required: true });
        ...
        core_default().setOutput("output", output);
    }
    catch (error) {
